		...
		<div class="nav-wraper">
			<div class="navbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="map.html"><img src="img/header/nav-icon4.png" alt="">Localisation</a></li>
					...
					<li class="nav-item"><a class="nav-link active" href="Livraison.php"><img src="img/header/nav-icon8.png" alt="">contact</a></li>
				</ul>
			</div>
		</div>
	</header>
			...
			<div class="col-lg-8 offset-lg-4">
				<div class="banner_content">
                    <div class="contact-form-section">
                        <h1>Passer La Livraison</h1>
                        <form  method="post">
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" name="adresse" placeholder="Votre Adresse">
                            </div>
                            <div class="form-group col-md-12">
                                <input type="number" min="11111111" max="99999999" class="form-control"  name="telephone1" placeholder="Telephone 1">
                            </div>
                            <div class="form-group col-md-12">
                                <input type="number" min="11111111" max="99999999" class="form-control"  name="telephone2" placeholder="Telephone 2">
                            </div>
                            ...
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn text-uppercase" name="submit">Livraison</button>
                            </div>
                        </form>
                    </div>
				</div>
...
<?php
    if(isset($_POST['submit'])){
        $liv=new livraison($_POST['adresse'], $_SESSION['id'],$_GET['commande'], $_POST['telephone1'], $_POST['telephone2']);
        $livs->ajouterlivraison($liv);
        ?>
        <script>
