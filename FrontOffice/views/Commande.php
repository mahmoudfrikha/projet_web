                    ...
                    <div class="contact-form-section">
                        ...
                        <form  method="post">
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" name="idcommande" placeholder="id commande">
                            </div>                   
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn text-uppercase" name="submit">Passer la Livraison</button>
                            </div>
                        </form>
                    </div>
				</div>
...
<?php
    if(isset($_POST['submit'])){
        $result =$livs->verifCommande($_POST['idcommande']);
        if($result==1){
        ?>
        <script>
            document.location.replace("Livraison.php?commande=<?php echo $_POST['idcommande']; ?>") ;
        </script>
        <?php
    	}
    	else
