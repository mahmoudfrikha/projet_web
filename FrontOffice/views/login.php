		...
		<div class="nav-wraper">
			<div class="navbar">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="Livraison.php"><img src="img/header/nav-icon8.png" alt="">Logout</a></li>
				</ul>
			</div>
		</div>
	</header>
                    ...
                    <div class="contact-form-section">
                        ...
                        <form  method="post">
                            ...
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn text-uppercase" name="submit">Connecter</button>
                            </div>
                        </form>
                    </div>
				</div>
...
<?php
    if(isset($_POST['submit'])){
        ...
        $mdp=$_POST['password'];
       $sql="select * from client where nom='$username' and mdp='$mdp'";
