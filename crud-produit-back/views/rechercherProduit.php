...
if (isset($_GET['query'])) {
	...
	<form action="rechercherProduit.php" method="get">
		Nom du produit <input type="text" name="query"> <button type="submit"> Rechercher </button></form>
<head>
  <script>
...
<div id="confirm">
	...
	<input type="submit" name="supprimer" value="supprimer" onclick='deleteconfirm = confirm("Cliquer sur OK pour confirmer, sinon sur annuler pour Annuler!"); return deleteconfirm'>
