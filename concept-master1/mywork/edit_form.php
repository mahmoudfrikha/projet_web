...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <link rel="stylesheet" href="\concept-master1\mywork\edit_form.css">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Events</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        
                                        <li class="nav-item">
                                            <a class="nav-link" href="create_form.php">Create Event</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="edit_form.php">Edit Event</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
...
<?php endif?>
      ...
      catch(Exception $e)
    {
     ...
     if (isset($_POST['search'])):
        ...
        $searched = $_POST['bar'];
        $query ="SELECT * FROM event WHERE CONCAT(event_id,nom_event,remise,date_debut,date_fin)LIKE CONCAT('%',:searched,'%')";
         $result = $db->prepare($query);
          $result->bindParam(':searched',$searched);
            $result->execute();
...
<?php endif?>
    ...
    <form action="edit_form.php" method="POST">
         ...
         <div  class="top-search-bar">
                                <input name="bar" class="form-control" type="text" placeholder="Search.."
    ...
    <table class="table">
       ...
       <tr>
            ...
            <td><?php echo $row['remise'];echo "%"?></td>
            <td><?php echo $row['date_debut'] ?></td>
            <td><?php echo $row['date_fin'] ?></td>
            <td>
               <a href="edit.php?edit=<?php echo $row['event_id'];?>"class="btn btn-info" id="edit">Edit</a>
               <a href="delete.php?delete=<?php echo $row['event_id'];?>"class="btn btn-danger">Delete</a>
           </td>
       </tr>
       <?php endwhile; ?>
    </table>   
